...
- [#1915](https://github.com/honojs/middleware/pull/1915) [`41d0f74d2885cf3278efb49eae4ef65abd18081c`](https://github.com/honojs/middleware/commit/41d0f74d2885cf3278efb49eae4ef65abd18081c) Thanks [@spokodev](https://github.com/spokodev)! - feat(otel): add `getRoute` config callback so downstream adapters can resolve `http.route`
