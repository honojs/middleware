...
// prettier-ignore
export const NON_RESPECTING_BOTS = ["AddSearchBot", "AgentTimes", "AI2Bot-DeepResearchEval", "AmazonBuyForMe", "Amzn-SearchBot", "Amzn-User", "Andibot", "anthropic-ai", "ApifyBot", "ApifyWebsiteContentCrawler", "Applebot", "Aranet-SearchBot", "Awario", "AzureAI-SearchBot", "bigsur.ai", "Brightbot", "Brightbot 1.0", "BuddyBot", "Bytespider", "Channel3Bot", "ChatGLM-Spider", "Claude-Code", "Claude-Web", "CloudVertexBot", "Code", "cohere-ai", "cohere-training-data-crawler", "Crawl4AI", "Datenbank Crawler", "DeepSeekBot", "Diffbot", "DuckAssistBot", "Echobot Bot", "EchoboxBot", "ExaBot", "facebookexternalhit", "Factset_spyderbot", "Gemini-Deep-Research", "Google-Agent", "Google-Firebase", "Google-Gemini-CLI", "Google-NotebookLM", "GoogleAgent-Mariner", "HenkBot", "iAskBot", "iaskspider", "iaskspider/2.0", "imageSpider", "img2dataset", "ISSCyberRiskCrawler", "kagi-fetcher", "Kangaroo Bot", "KunatoCrawler", "laion-huggingface-processor", "LAIONDownloader", "LCC", "LinerBot", "Linguee Bot", "LinkupBot", "Manus-User", "Meta-ExternalAgent", "meta-externalfetcher", "Meta-ExternalFetcher", "meta-webindexer", "MistralAI-User", "MyCentralAIScraperBot", "NagetBot", "netEstate Imprint Crawler", "newsai", "NotebookLM", "NovaAct", "opencode", "Operator", "PanguBot", "Perplexity-User", "PhindBot", "Poggio-Citations", "Poseidon Research Crawler", "QualifiedBot", "QuillBot", "quillbot.com", "Scrapy", "Shap-User", "Sidetrade indexer bot", "Spider", "TavilyBot", "Terra Cotta", "Thinkbot", "TikTokSpider", "Timpibot", "Trae", "TwinAgent", "WARDBot", "Webzio-Extended", "webzio-extended", "wpbot", "WRTNBot", "YaK", "ZanistaBot"];
// prettier-ignore
