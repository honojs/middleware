  ...
  type Expected = {
    '/author': {
      $post:
        ...
        | {
            input: AuthorInput
            output: z.ZodSafeParseError<z.output<typeof jsonSchema>>
            outputFormat: 'json'
            status: 400
          }
        | {
            input: AuthorInput
            output: z.ZodSafeParseError<z.output<typeof querySchema>>
            outputFormat: 'json'
            status: 400
          }
    }
    ...
    type MixedExpected = {
      '/mixed': {
        $get:
          ...
          | {
              input: MixedInput
              output: z.ZodSafeParseError<z.output<typeof mixedSchema>>
              outputFormat: 'json'
              status: 400
            }
      }
    ...
    type Expected = {
      '/': {
        $get:
          ...
          | {
              input: HeaderInput
              output: z.ZodSafeParseError<z.output<typeof headerSchema>>
              outputFormat: 'json'
              status: 400
            }
      }
